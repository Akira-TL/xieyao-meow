谢邀喵 / Xieyao Meow
ART GENERATION PROMPTS v1
2026-09-13

用途：给外部图像生成工具使用。
原则：先锁视觉风格，再锁六个角色母版；后续所有角色图都必须基于母版 reference/edit，不允许仅靠文字“重新生成一个类似角色”。
...
STEP 1 生成 STYLE MASTER
STEP 2 生成并人工确认 6 个 CHARACTER MASTER
STEP 3 使用 CHARACTER MASTER 作为参考图，生成 pose / avatar / variant
STEP 4 角色稳定后，生成 egg / room / journey / encounter / collectible

任何后续角色生成，都必须附加下面这段“身份锁定指令”：
