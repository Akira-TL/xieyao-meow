  ...
  return (
    <DemoPage scene="encounter">
      ...
      <section className="share-stage">
        <p className="stage-caption">SCENE 07 · 初次相遇 · 第一段关系成立</p>
        ...
        <div className="relationship-beliefs">
          ...
          <article><b>♥</b><strong>对问题保有长期耐心</strong><span>相信时间会给出更好的答案。</span></article>
          <article><b>◆</b><strong>理性与感性刚好互补</strong><span>理性的思考，感性的温度，拼出更完整的世界。</span></article>
        </div>
